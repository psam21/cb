...
const involvementTypes = [
  {
    ...
    description:
      'Share your cultural heritage, traditions, and family stories with the global community.',
...
const volunteerStories = [
  {
    ...
    location: 'Guatemala',
    story:
      "I've recorded over 30 hours of Mayan elder stories in the past year. Seeing grandchildren connect with their heritage through these recordings brings me incredible joy.",
  ...
  },
  {
    ...
    story:
      "Contributing to Culture Bridge's Nostr integration has been incredibly rewarding. Knowing that my code helps preserve cultural heritage motivates me every day.",
  ...
  },
  {
    ...
    story:
      "I organize monthly cultural storytelling events in my community. We've connected over 50 local storytellers with the global Culture Bridge network.",
        ...
        <div className="container-width">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Find the perfect way to contribute your time and skills to global cultural
              preservation.
            </p>
          </motion.div>
            ...
            {involvementTypes.map((type, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`card p-6 cursor-pointer transition-all duration-300 ${isSelected ? 'border-2 border-accent-400 bg-accent-50 shadow-lg transform scale-105' : 'hover:shadow-lg hover:transform hover:scale-102'}`}
                  onClick={() => setSelectedType(isSelected ? null : index)}
                >
                  <div className="flex items-center justify-between mb-4">
                    <div
                      className={`w-12 h-12 rounded-lg flex items-center justify-center ${isSelected ? 'bg-accent-600 text-white' : 'bg-primary-100 text-primary-800'}`}
                    >
                      <Icon className="w-6 h-6" />
                    </div>
                    <div className="text-right">
                      <div
                        className={`text-sm font-medium ${type.difficulty === 'Beginner' ? 'text-green-600' : type.difficulty === 'Intermediate' ? 'text-yellow-600' : 'text-red-600'}`}
                      >
                        {type.difficulty}
                      </div>
                    </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-width">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Your financial support helps us maintain the platform, fund community programs, and
              keep cultural stories freely accessible to all.
            </p>
          </motion.div>
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {supportLevels.map((level, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className={`card p-6 text-center cursor-pointer transition-all duration-300 ${selectedSupport === index ? 'border-2 border-accent-400 bg-accent-50 shadow-lg transform scale-105' : level.popular ? 'border-2 border-primary-400 shadow-lg' : 'hover:shadow-lg'}`}
              ...
              >
                ...
                <div className="text-3xl font-bold text-accent-600 mb-4">{level.amount}</div>
                ...
                <button
                  className={`w-full ${selectedSupport === index ? 'btn-accent' : 'btn-outline'}`}
                >
                  Choose This Level
                </button>
              </motion.div>
        ...
        <div className="container-width">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8 leading-relaxed">
              Every story shared, every hour volunteered, and every dollar donated helps preserve
              the beautiful diversity of human culture for future generations.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/get-involved/volunteer"
                className="btn-accent"
                aria-label="Start volunteering today"
              >
