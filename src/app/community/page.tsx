...
const communityMembers = [
  ...
  },
  {
    ...
    fallback: 'data:image/svg+xml;base64,',
    contributions: 32,
    followers: 1650,
    joined: '2024-01-08',
    status: 'active',
              ...
              return (
                ...
                >
                  <div className="relative mb-4">
                    ...
                    />
                    <div className="absolute bottom-0 right-1/2 transform translate-x-6 translate-y-2 bg-white rounded-full p-2 shadow-lg">
                  ...
                  <div className="flex items-center justify-center text-sm text-gray-600 mb-3">
                    ...
                    <span>{member.culture} • {member.location}</span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-1 justify-center mb-4">
                    {member.specialties.slice(0, 2).map((specialty, idx) => (
                      <span key={idx} className="text-xs bg-accent-50 text-accent-700 px-2 py-1 rounded-full">
                        {specialty}
                      </span>
                    ))}
                  </div>
        ...
        <div className="container-width">
          ...
          >
            ...
            <p className="text-xl text-accent-100 mb-8 leading-relaxed">
              Become part of a vibrant community where cultural exchange happens every day. 
              Share your stories, learn from others, and help build bridges between cultures.
            </p>
