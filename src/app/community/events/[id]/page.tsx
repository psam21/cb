...
export const metadata: Metadata = {
  title: 'Community Event – Culture Bridge',
};

type PageProps = { params?: Promise<{ id?: string | string[] }> };

export default async function CommunityEventPage({ params }: PageProps) {
    ...
    <div className="min-h-screen bg-white">
      <section className="section-padding">
        <div className="container-width max-w-3xl">
          <h1 className="text-3xl md:text-4xl font-serif font-bold text-primary-800 mb-4">Community Event</h1>
